...
export function AddPlacePopup(props) {
  ...
  return (
    ...
    >
      <input
        className="popup__input popup__input_first"
        id="input-nameImage"
        ref={namePlaceRef}
        type="text"
        ...
        required
      />
      <span className="popup__errorMessage input-nameImage-error">
      ...
      <input
        ...
        required
      />
      <span className="popup__errorMessage input-linkImage-error">
        Введите адрес сайта
      </span>
    </PopupWithForm>
  );
